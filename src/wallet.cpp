...
// NamoCoin: total coins staked (non-spendable until maturity)
        ...
        CTxDB txdb("r");
        {
            ...
            while (true)
            {
                ...
                if (nChange > 0)
                {
                    ...
                    // change transaction isn't always pay-to-NamoCoin-address
...
// NamoCoin: get current stake weight
...
// NamoCoin: check 'spent' consistency between wallet and txindex
// NamoCoin: fix wallet spent state according to txindex
...
// NamoCoin: disable transaction (only for coinstake)
